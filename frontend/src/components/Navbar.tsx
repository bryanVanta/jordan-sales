...
const NavbarContent = () => {
  ...
  const displayName = profile ? profile.firstName : 'Jordan';
  const avatarUrl = profile && profile.avatar ? profile.avatar : null;
  ...
  return (
    <nav className="flex items-center justify-between px-8 py-3 w-full max-w-[1600px] mx-auto bg-transparent z-[100] relative">
      <div className="flex-1 flex items-center">
        <span className="text-xl font-bold tracking-tight text-white border-b-2 border-transparent pb-1">{displayName}</span>
      </div>
      ...
      <div className="flex-1 flex items-center justify-end relative">
        ...
        >
          ...
          <div className="flex flex-col items-start justify-center">
            <span className="text-[14px] font-bold text-white leading-tight mb-0.5">{displayName}</span>
            ...
            <div className="absolute top-16 right-0 w-[280px] bg-white rounded-[32px] shadow-[0_20px_60px_rgba(0,0,0,0.5)] border border-gray-100 p-6 z-[110] animate-in fade-in slide-in-from-top-4 duration-300">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div className="flex flex-col">
                  <span className="text-gray-900 font-extrabold text-[15px] leading-tight">{displayName}</span>
