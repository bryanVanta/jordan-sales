...
export default function Dashboard() {
  ...
  return (
    <main className="max-w-[1440px] mx-auto px-6 md:px-10 pb-10">
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-start">
        
        {/* ROW 1 */}
        {/* Sales Insights (7/12 columns) */}
        <div className="xl:col-span-7 bg-white rounded-[32px] p-8 shadow-sm border border-gray-100/50 h-[420px] flex flex-col">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-bold text-gray-800 tracking-tight">Sales Insights</h2>
            <div className="flex gap-6 items-center">
              <div className="flex items-center gap-2 text-sm font-medium text-gray-600"><span className="w-4 h-1 rounded-full bg-red-400"></span> Hot</div>
              <div className="flex items-center gap-2 text-sm font-medium text-gray-600"><span className="w-4 h-1 rounded-full bg-blue-400"></span> Cold</div>
              <div className="flex items-center gap-2 text-sm font-medium text-gray-600"><span className="w-4 h-1 rounded-full bg-yellow-400"></span> Warm</div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-[32px] p-8 shadow-sm border border-gray-100/50 relative overflow-hidden flex flex-col xl:col-span-5 h-[420px]">
          <div className="flex justify-between items-center mb-6 relative z-20">
            <h2 className="text-[1.3rem] font-bold text-gray-800 tracking-tight leading-tight w-[60%]">Lead Temperature Overview</h2>
          ...
          <div className="flex-1 relative">
            {/* TEMPERATURE STICKER - Shifted more to the right and made larger behind */}
            ...
            {/* INCREASED WIDTH (75%) and REDUCED ROUNDING (24px) to prevent layout cuts */}
            <div className="grid grid-cols-2 gap-4 w-[75%] h-full z-10 relative my-auto py-2">
              {/* Hot Box */}
              <div className="bg-[#FFF0EB] p-5 rounded-[24px] flex flex-col border border-orange-100 justify-center group hover:bg-[#ffe5da] transition-colors relative overflow-hidden h-32 z-10">
                <Flame size={64} strokeWidth={1} className="absolute -right-3 -bottom-3 text-orange-200 opacity-40" />
                <div className="flex items-center gap-3 mb-2 z-10">
                  <span className="text-orange-900 font-bold text-base">Hot</span>
                  <div className="bg-white/60 text-orange-700 px-2 py-0.5 rounded-full text-[11px] font-bold flex items-center gap-0.5 shadow-sm border border-orange-100/50">
              ...
              {/* Cold Box */}
              <div className="bg-[#EBF4FF]/90 backdrop-blur-sm p-4 rounded-[24px] flex flex-col border border-blue-100 justify-center group hover:bg-blue-50/100 transition-colors relative overflow-hidden h-32 z-10">
                <Snowflake size={64} strokeWidth={1} className="absolute -right-3 -bottom-3 text-blue-200 opacity-40" />
                <div className="flex items-center gap-2 mb-2 z-10">
                  <span className="text-blue-900 font-bold text-base">Cold</span>
                  <div className="bg-white/60 text-blue-700 px-2 py-0.5 rounded-full text-[11px] font-bold flex items-center gap-0.5 shadow-sm border border-blue-100/50">
              ...
              {/* Warm Box */}
              <div className="bg-[#FFFDF0] p-5 rounded-[24px] flex flex-col border border-yellow-100 justify-center group hover:bg-[#fffbe0] transition-colors relative overflow-hidden h-32 z-10">
                <Sun size={64} strokeWidth={1} className="absolute -right-3 -bottom-3 text-yellow-200 opacity-50" />
                <div className="flex items-center gap-3 mb-2 z-10">
                  <span className="text-yellow-900 font-bold text-base">Warm</span>
                  <div className="bg-white/60 text-yellow-700 px-2 py-0.5 rounded-full text-[11px] font-bold flex items-center gap-0.5 shadow-sm border border-yellow-100/50">
              ...
              {/* Neutral Box */}
              <div className="bg-gray-50/90 backdrop-blur-sm p-5 rounded-[24px] flex flex-col border border-gray-200 justify-center group hover:bg-gray-100/100 transition-colors relative overflow-hidden h-32 z-10">
                <Cloud size={64} strokeWidth={1} className="absolute -right-3 -bottom-3 text-gray-200 opacity-60" />
                <div className="flex items-center gap-3 mb-2 z-10">
                  <span className="text-gray-900 font-bold text-base">Neutral</span>
                  <div className="bg-white/60 text-gray-700 px-2 py-0.5 rounded-full text-[11px] font-bold flex items-center gap-0.5 shadow-sm border border-gray-200/50">
                     <TrendingUp size={12} strokeWidth={3} /> +1
                  </div>
                </div>
        ...
        <div className="bg-white rounded-[32px] p-6 shadow-sm border border-gray-100/50 flex flex-col xl:col-span-4 h-[350px]">
          ...
          <div className="flex-1 flex flex-col w-full h-full space-y-2">
            ...
            <div className="grid grid-cols-2 gap-3 mt-auto pt-2">
              <div className="bg-blue-50 border border-blue-100 p-3 rounded-[24px] flex flex-col justify-center items-center h-[95px] w-full">
                ...
                <span className="text-4xl font-extrabold text-blue-900">142</span>
              </div>
              <div className="bg-purple-50 border border-purple-100 p-3 rounded-[24px] flex flex-col justify-center items-center h-[95px] w-full">
                ...
                <span className="text-4xl font-extrabold text-purple-900">38</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#E7F0FF] rounded-[32px] p-8 shadow-sm flex flex-col justify-center items-center border border-blue-100 relative overflow-hidden group hover:shadow-md transition-shadow xl:col-span-4 h-[350px]">
          ...
          <div className="z-10 flex flex-col items-center justify-center h-full space-y-5 w-full max-w-sm">
            <h2 className="text-[1.8rem] font-black text-blue-900 tracking-tight text-center italic opacity-85 decoration-4 underline-offset-4">AI Insights</h2>
            <div className="bg-white/60 backdrop-blur-sm p-5 rounded-[20px] border border-white w-full">
              <p className="text-blue-950 text-center font-medium leading-relaxed text-[15px]">
            ...
            <button className="bg-white text-blue-800 px-8 py-3 w-full rounded-full font-bold shadow-sm text-sm border border-blue-100 hover:bg-blue-50 transition-colors hover:-translate-y-1 transform duration-300">
               Explore Strategy
            </button>
          </div>
        </div>
        ...
        <div className="xl:col-span-4 h-[350px]" style={{ perspective: '1200px' }}>
